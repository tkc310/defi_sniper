...
const privateKey = "private-key"; // Private Key of Sender/Receiver Address
...
const web3 = new Web3('ANKR API WEBSOCKET LINK');
...
const Swap = async (tokenIn, tokenOut) => {
    ...
    process.on('unhandledRejection', (error, promise) => {
        console.log('-------------------------------- Rejected, review your BNB balance for fees or contact bot-support, retrying... -------------------');
      });
